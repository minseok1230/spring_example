	...
	<div class="container">
		...
		<form method="post" action="/lesson06/ex01/add_user">
			<div class="form-group">
				...
				<input class="form-control col-3" type="text" id="name" name="name" placeholder="이름을 입력하세요">
			</div>
			<div class="form-group">
				<label for="yyyymmdd"><b>생년월일</b></label>
				<input class="form-control col-3" type="text" id="yyyymmdd" name="yyyymmdd" placeholder="예) 19990111">
			</div>
			<div class="form-group">
				<label for="email"><b>이메일</b></label>
				<input class="form-control col-3" type="text" id="email" name="email" placeholder="이메일을 입력해주세요">
			</div>
			<div class="form-group">
				<label for="introduce"><b>자기소개</b></label>
				<textarea class="form-control col-3" id="introduce" name="introduce"></textarea>
			</div>
...
<script>
	$(document).ready(function(){
		...
		/* $('form').on('submit', function(e){
			...
			if (name == '') {
				alert("이름을 입력하세요");
				return false; // submt 안함, submit 이벤트일 때 return false
			}
